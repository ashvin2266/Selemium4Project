...
//        careerPage.selectLocation(locationCity);
        careerPage.enterLocation(locationCity);
    }
    ...
    public void userClickOnViewAllJobs() {
        careerPage.clickViewAllJobs();

    }

    @And("user enter {string} in search bar")
    public void userEnterInSearchBar(String arg0) {
        careerPage.enterJobTitle(arg0);
